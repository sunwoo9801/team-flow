          ...
          <div className="p-3 border-b border-zinc-100 space-y-2">
            ...
            <div className="flex gap-1.5">
              <input
                ...
                placeholder="메모 (선택)"
                className="flex-1 h-7 px-2 text-xs bg-zinc-50 border border-zinc-200 rounded-lg
                           focus:outline-none focus:ring-2 focus:ring-blue-100 focus:border-blue-400"
              />
              <button
                onClick={handleCreate}
                disabled={isCreating}
                className="h-7 px-3 text-xs font-semibold text-white bg-blue-600 hover:bg-blue-700
                           disabled:bg-zinc-300 rounded-lg transition-colors"
              >
                스냅샷
              </button>
            </div>
                  ...
                  <div className="flex items-start justify-between gap-2">
                    ...
                    <div className="flex items-center gap-1 shrink-0">
                      <button
                        ...
                        className="h-6 px-2 text-[11px] font-semibold text-blue-600 hover:bg-blue-50
